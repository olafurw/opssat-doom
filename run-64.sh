...
do
    ./src/bin/opssat-doom -nosound -nomusic -nosfx -runid $runid -longtics -iwad demos/doom-earth.wad -cdemo $demos_folder/$demo -statdump ${statdump_filepath} >> toGround/doom.log 2>&1;
