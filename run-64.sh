...
do
    ./src/bin/opssat-doom -nosound -nomusic -nosfx -nodraw -runid 1 -iwad demos/doom.wad -cdemo $demos_folder/$demo -statdump toGround/run-64.txt >> toGround/doom.log 2>&1;
