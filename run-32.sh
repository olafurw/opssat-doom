...
statdump_filepath=toGround/run-32.txt

for demo in $demos_shareware
do
    qemu-arm src/bin/opssat-doom -nosound -nomusic -nosfx -runid 1 -longtics -iwad demos/doom.wad -cdemo $demos_folder/$demo -statdump ${statdump_filepath} >> toGround/doom.log 2>&1;
